...
public class BonusBalle extends Sprite {
    ...
    public BonusBalle(int x, int y, int vitesseX, int vitesseY) {
        this.x = x;
        this.y = y;
    ...
    public BonusBalle(int x, int y, int vitesseX, int vitesseY, Color couleur) {
        this.x = x;
        this.y = y;
        this.vitesseX = vitesseX;
        this.vitesseY = vitesseY;
